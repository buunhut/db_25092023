...
# docker run -d -p 8080:8080 -e DATABASE_URL=mysql://root:123456@61.14.233.80:3306/db_25092023?schema=public -e USER_NAME=root -e PASS=123456 --name cons-backend img-backend
